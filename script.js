...
!(function (a) {
  ...
  function B() {
    ...
    function e(b) {
      ...
      a !== h
        ? c(h)
        : (g('In page link (#' + e + ') not found in iFrame, so sending to parent'),
          R(0, 0, 'inPageLink', '#' + e));
    }
    function f() {
  ...
  function M(b, c, d, e) {
    ...
    function h() {
      ...
      return (
        (m = a !== d ? d : Ia[fa]()), (n = a !== e ? e : Ja[Aa]()), b(da, m) || (_ && b(ya, n))
      );
    }
    function i() {
  ...
  function S(a) {
    ...
    function l() {
      !1 === ca
        ...
        : j()
        ? m.init()
        : g('Ignored message of type "' + d() + '". Received before initialization.');
    }
    var m = {
      init: function () {
        function c() {
        ...
        'interactive' === document.readyState || 'complete' === document.readyState
          ? c()
          : (g('Waiting for page ready'), b(window, 'readystatechange', m.initFromParent));
      },
      reset: function () {
